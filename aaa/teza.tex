...
\section{Interpretarea Detaliată a Rezultatelor}

Analiza performanței aplicației s-a bazat pe date colectate în două momente relevante: la 2-3 minute și la 15 minute de la începutul testului, pentru a surprinde atât comportamentul inițial, cât și stabilitatea pe termen lung.

\subsection{Debitul și Stabilitatea Sistemului}

Graficul \textit{Total Requests per Second} indică o performanță robustă:

\begin{itemize}
    \item Sistemul atinge rapid debitul maxim și se stabilizează în primele secunde.
    \item Debit constant în jur de 150 RPS pe întreaga durată a testului.
    \item Număr de eșecuri constant 0, demonstrând fiabilitatea aplicației.
\end{itemize}

Date agregate:
\begin{itemize}
    \item După 2-3 minute: 150.2 RPS
    \item După 15 minute: 135.8 RPS
\end{itemize}

\subsection{Timpii de Răspuns și Percentilele}

Percentilele sunt esențiale pentru a înțelege experiența utilizatorului:

\begin{itemize}
    \item \textbf{Median (50\%):} jumătate dintre cereri au timp de răspuns egal sau mai mic.
    \item \textbf{Percentila 95:} 95\% dintre cereri sunt mai rapide decât această valoare.
    \item \textbf{Percentila 99:} 99\% dintre cereri sunt mai rapide, indicând experiența utilizatorilor cu cei mai slabi timpi de răspuns.
\end{itemize}

\subsubsection{Rezultate Agregate (Toate Cererile)}
...
\subsection{Utilizarea Resurselor Sistemului}

\begin{itemize}
    \item \textbf{CPU:} Intel i5-9300H a înregistrat utilizare de 82\% la începutul testului și ~65\% după 10 minute, indicând încărcare intensă.
    \item \textbf{Memorie:} Consumul de RAM a fost constant ~11.5 GB din 15.8 GB (72-73\%), fără semne de scurgeri de memorie.
\end{itemize}

\subsection{Concluzii}

Analiza detaliată confirmă că aplicația are performanță generală bună și stabilă. Totuși, câteva operațiuni critice, în special autentificarea și editarea profilului, prezintă latențe mari, necesitând optimizare pentru a îmbunătăți experiența utilizatorilor.
